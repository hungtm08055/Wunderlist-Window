<?php
    ...
    $status = $_GET['confirmCode'];
    if($status == true)
    {
        echo '<script language = "javascript">';
        echo 'alert("Correct Code! Now you can change your password.")';
        echo '</script>'; 
    }
    $status = $_GET['invalidEmail'];
    if($status == true)
    {
        echo '<script language = "javascript">';
        echo 'alert("Email does not exist, please try again")';
        echo '</script>'; 
    }
...
<body>
    ...
    <div class="login-form">
        <form class="loginTab signup" action="../php/Process/xulyResetPassword.php" method="POST">
            <input type="hidden" name="id_email" value=""> <!--chưa hiểu-->
