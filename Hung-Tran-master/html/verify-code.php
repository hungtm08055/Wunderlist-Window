<?php
    ...
    $status = $_GET['confirmEmail'];
    if($status == true)
    {
        echo '<script language = "javascript">';
        echo 'alert("Successfully sent, please check the number sequence in your email!")';
        echo '</script>'; 
    }
    $status = $_GET['wrongCode'];
    if($status == true)
    {
        echo '<script language = "javascript">';
        echo 'alert("Invalid number, please check and try again!")';
        echo '</script>'; 
    }
    $html =  $_SESSION['randomNumber'];
    print_r($html);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="login-form">
        <form class="loginTab signin" action="../php/Process/xulyVerifyCode.php" method="POST">
            <div class="header-form">Account recovery</div>
            ...
            <div class="loginTab-input-address">
                ...
                <div class="loginTab-input-fieldInput">
                    <input type="text" name="code" value="" required="" autofocus="" placeholder="Enter the code sent to your email ">
                </div>
            </div>
            <div class="button-login">
                <input type="submit"  value="Confirm Account" name="confirm_Email">
            </div>
        </form>
