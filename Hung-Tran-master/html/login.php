...
<body>
    ...
    <div class="login-form">
        <form class="loginTab signin" action="../php/Process/xulylogin.php" method="POST">
            <!-- <input style="display:none;" type="text" name="id" value="<?php ?>"> chưa hiểu -->
